...
public class ClientCommandHelper {
    ...
    private void parseForCommon(TurtleProtoBuf.ClientCommand clientCommand){
        ...
        clientCommand.getParasList().forEach(para->{
         ...
         switch (paraType){
             case STRING:paraTypes.add(String.class);break;
             case DOUBLE:paraTypes.add(Double.class);break;
             case INTEGER:paraTypes.add(Integer.class);break;
             case LONG:paraTypes.add(Long.class);break;
             case NUMBER_INTEGER:paraTypes.add(BigInteger.class);break;
             case NUMBER_DECIMAL:paraTypes.add(BigDecimal.class);break;
             case TURTLE_VALUE:paraTypes.add(TurtleValue.class);break;
             default:throw new UnsupportedOperationException();
         }
   ...
   TurtleValue res;
      switch (type){
          case STRING:res=new TurtleValue()
      }
    }
